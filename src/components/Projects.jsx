    ...
    <section id="projects">
      ...
      <section className="title">
        ...
        <div>
          ...
          <p>
            Different tools where used to build these site. You can only see the
            source code but ont the live due to hosting problem but Others
            project below can be view live . <span><a href="#allproject" className="aDivLink">Others Project</a></span>
          </p>
        </div>
      </section>
        ...
        >
          <SwiperSlide>
            ...
            <div>
                ...
                <h4><a href="https://github.com/gcrajan/shareall" target="_blank" className="btn-link">Source Code</a></h4>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            ...
            <div>
                ...
                <h4><a href="https://github.com/gcrajan/SaralSarkar" target="_blank" className="btn-link">Source Code</a></h4>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            ...
            <div>
                ...
                <h4><a href="https://github.com/gcrajan/DigitalMatadan" target="_blank" className="btn-link">Source Code</a></h4>
            </div>
          </SwiperSlide>
        </Swiper>
      </section>
      ...
      <section className="otherProject">
        <div className="projectTopic">
            ...
            <motion.button className="filterBtn btn-link" onClick={()=>filterItems("HTML")} whileInView={animations.whileInView} initial={animations.btn2}>HTML</motion.button>
            ...
            {dataItems.map((items)=>{
                ...
                transition={{ delay: 0.3 }}>
                    ...
                    <div className="projectInfo">
                        ...
                        <a href={demoUrl} target="_blank">Demo Live</a>
                    </div>
                </motion.article2>
            })}
        </div>
